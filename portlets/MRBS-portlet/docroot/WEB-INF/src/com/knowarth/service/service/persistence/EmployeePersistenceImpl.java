...
import com.knowarth.service.NoSuchEmployeeException;
import com.knowarth.service.model.Employee;
import com.knowarth.service.model.impl.EmployeeImpl;
import com.knowarth.service.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	...
	@Override
	public Employee updateImpl(com.knowarth.service.model.Employee employee)
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setEmployeeEmailId(employee.getEmployeeEmailId());
		employeeImpl.setStateId(employee.getStateId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.knowarth.service.model.Employee")));
