...
/**
 * Provides the local service interface for IndianState. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author shyam.vadera
 * @see IndianStateLocalServiceUtil
...
public interface IndianStateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IndianStateLocalServiceUtil} to access the indian state local service. Add custom service methods to {@link com.knowarth.service.service.impl.IndianStateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
