...
public class BookWrapper implements Book, ModelWrapper<Book> {
	...
	*/
	...
	@Override
	public int compareTo(com.proliferay.sbuilder.example.crud.model.Book book) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.proliferay.sbuilder.example.crud.model.Book> toCacheModel() {
		return _book.toCacheModel();
	}

	@Override
	public com.proliferay.sbuilder.example.crud.model.Book toEscapedModel() {
		return new BookWrapper(_book.toEscapedModel());
	}

	@Override
	public com.proliferay.sbuilder.example.crud.model.Book toUnescapedModel() {
