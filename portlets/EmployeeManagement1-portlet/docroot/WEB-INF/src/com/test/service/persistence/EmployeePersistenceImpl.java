...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_EMAILID = new FinderPath(EmployeeModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeModelImpl.FINDER_CACHE_ENABLED, EmployeeImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByemailId",
			new String[] { String.class.getName() },
			EmployeeModelImpl.EMAILID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_EMAILID = new FinderPath(EmployeeModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public Employee findByemailId(String emailId)
		...
		Employee employee = fetchByemailId(emailId);
	 ...
	 */
	@Override
	public Employee fetchByemailId(String emailId) throws SystemException {
		return fetchByemailId(emailId, true);
	}
	 ...
	 */
	@Override
	public Employee fetchByemailId(String emailId, boolean retrieveFromCache)
		...
		if (result instanceof Employee) {
			...
			if (!Validator.equals(emailId, employee.getEmailId())) {
				result = null;
			}
		}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"EmployeePersistenceImpl.fetchByemailId(String, boolean) with parameters (" +
					...
					if ((employee.getEmailId() == null) ||
							!employee.getEmailId().equals(emailId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_EMAILID,
							finderArgs, employee);
					}
				}
	 ...
	 */
	@Override
	public Employee removeByemailId(String emailId)
		throws NoSuchEmployeeException, SystemException {
		Employee employee = findByemailId(emailId);
	...
	private static final String _FINDER_COLUMN_EMAILID_EMAILID_1 = "employee.emailId IS NULL";
	private static final String _FINDER_COLUMN_EMAILID_EMAILID_2 = "employee.emailId = ?";
	private static final String _FINDER_COLUMN_EMAILID_EMAILID_3 = "(employee.emailId IS NULL OR employee.emailId = '')";
	...
	public void cacheResult(Employee employee) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_EMAILID,
			new Object[] { employee.getEmailId() }, employee);
	...
	protected void cacheUniqueFindersCache(Employee employee) {
		if (employee.isNew()) {
			Object[] args = new Object[] { employee.getEmailId() };
	...
	protected void clearUniqueFindersCache(Employee employee) {
		...
		if ((employeeModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_EMAILID.getColumnBitmask()) != 0) {
			args = new Object[] { employeeModelImpl.getOriginalEmailId() };
	...
	@Override
	public Employee updateImpl(com.test.model.Employee employee)
		throws SystemException {
		employee = toUnwrappedModel(employee);
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setJoiningDate(employee.getJoiningDate());
		employeeImpl.setDepartment(employee.getDepartment());
		employeeImpl.setEmailId(employee.getEmailId());
		employeeImpl.setCountry(employee.getCountry());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.Employee")));
